...
{{{2 The & for replacing
:%s/stuff/&other/			: append other to stuff
}}}2
:%s/\v(.*\n){5}/&\r         : insert a blank line every 5 lines *N*										<cr>
...
:nmap <leader>z :%s#\<<c-r>=expand("<cword>")<cr>\>#													<cr>
" Pull Visually Highlighted text into LHS of a substitute
:vmap <leader>z :<C-U>%s/\<<c-r>*\>/																<cr>
...
{{{2 display text searched with line number
...
:g/^/exe ".w ".line(".").".txt"
----------------------------------------
" Summary of editing repeats *N* {{{2
.      last edit (magic dot)
:&     last substitute
...
----------------------------------------
" Make all other tips superfluous {{{2
:h 42            : also http://www.google.com/search?q=42
:h holy-grail
:h!
---------------------------------------- }}}2
" Markers & moving about {{{2
